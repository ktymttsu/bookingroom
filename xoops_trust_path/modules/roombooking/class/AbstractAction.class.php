...
/**
 * Roombooking_AbstractAction
**/
abstract class Roombooking_AbstractAction
{
    public /*** XCube_Root ***/ $mRoot = null;

    public /*** Roombooking_Module ***/ $mModule = null;

    public /*** Roombooking_AssetManager ***/ $mAsset = null;
    ...
    **/
     ...
     * @param   void
     * 
     * @return  Roombooking_{Tablename}Handler
    **/
    ...
    **/
    ...
    {
        return ROOMBOOKING_FRAME_VIEW_NONE;
    }
