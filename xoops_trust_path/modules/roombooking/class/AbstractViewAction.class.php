...
/**
 * Roombooking_AbstractViewAction
**/
abstract class Roombooking_AbstractViewAction extends Roombooking_AbstractAction
{
	...
	**/
	...
	{
		$this->mRoot->mController->executeRedirect($this->_getNextUri($this->_getConst('DATANAME'), 'list'), 1, _MD_ROOMBOOKING_ERROR_CONTENT_IS_NOT_FOUND);
	}
}
