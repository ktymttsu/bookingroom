...
/**
 * Roombooking_AbstractEditAction
**/
abstract class Roombooking_AbstractEditAction extends Roombooking_AbstractAction
{
    ...
    **/
    public function getDefaultView()
    {
        ...
        return ROOMBOOKING_FRAME_VIEW_INPUT;
    }
    ...
    **/
    public function execute()
    {
        ...
        {
            return ROOMBOOKING_FRAME_VIEW_CANCEL;
        }
    ...
    **/
    ...
    {
        $this->mRoot->mController->executeRedirect($this->_getNextUri($this->_getConst('DATANAME')), 1, _MD_ROOMBOOKING_ERROR_DBUPDATE_FAILED);
    }
