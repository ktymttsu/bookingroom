...
/**
 * Roombooking_AbstractListAction
**/
abstract class Roombooking_AbstractListAction extends Roombooking_AbstractAction
{
	public /*** XoopsSimpleObject[] ***/ $mObjects = null;

	public /*** Roombooking_AbstractFilterForm ***/ $mFilter = null;
	 ...
	 * @param	void
	 * 
	 * @return	Roombooking_{Tablename}FilterForm
	**/
	...
	**/
	public function getDefaultView()
	{
		...
		return ROOMBOOKING_FRAME_VIEW_INDEX;
	}
