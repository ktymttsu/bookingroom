...
/**
 * Roombooking_AssetManager
**/
class Roombooking_AssetManager
{
    public /*** string ***/ $mDirname = '';

    public /*** string ***/ $mTrustDirname = 'roombooking';
    ...
    **/
     ...
     * @param   string  $dirname
     * 
     * @return  Roombooking_AssetManager
    **/
    public function &getInstance(/*** string ***/ $dirname)
    {
        /**
         *  @var    Roombooking_AssetManager[]
        **/
    ...
    **/
    ...
    {
        return ROOMBOOKING_TRUST_PATH . ($isAdmin ? '/admin/' : '/');
    }
}
