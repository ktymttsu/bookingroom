...
define('ROOMBOOKING_FRAME_PERFORM_SUCCESS', 1);
define('ROOMBOOKING_FRAME_PERFORM_FAIL', 2);
define('ROOMBOOKING_FRAME_INIT_SUCCESS', 3);

define('ROOMBOOKING_FRAME_VIEW_NONE','none');
define('ROOMBOOKING_FRAME_VIEW_SUCCESS','success');
define('ROOMBOOKING_FRAME_VIEW_ERROR','error');
define('ROOMBOOKING_FRAME_VIEW_INDEX','index');
define('ROOMBOOKING_FRAME_VIEW_INPUT','input');
define('ROOMBOOKING_FRAME_VIEW_PREVIEW','preview');
define('ROOMBOOKING_FRAME_VIEW_CANCEL','cancel');

/**
 * Roombooking_Module
**/
class Roombooking_Module extends Legacy_ModuleAdapter
{
	public /*** string ***/ $mActionName = null;

	public /*** Roombooking_AbstractAction ***/ $mAction = null;

	public /*** bool ***/ $mAdminFlag = false;

	public /*** Roombooking_AssetManager ***/ $mAssetManager = null;
	...
	protected /*** Enum[] ***/ $_mAllowViewNames = array(
		ROOMBOOKING_FRAME_VIEW_NONE,
		ROOMBOOKING_FRAME_VIEW_SUCCESS,
		ROOMBOOKING_FRAME_VIEW_ERROR,
		ROOMBOOKING_FRAME_VIEW_INDEX,
		ROOMBOOKING_FRAME_VIEW_INPUT,
		ROOMBOOKING_FRAME_VIEW_PREVIEW,
		ROOMBOOKING_FRAME_VIEW_CANCEL
	);
	...
	**/
	public function startup()
	{
		...
		XCube_DelegateUtils::call('Module.roombooking.Global.Event.GetAssetManager',new XCube_Ref($this->mAssetManager),$this->mXoopsModule->get('dirname'));
	...
	**/
	private function _getDefaultActionName()
	{
		...
		$dataname = isset($dataname) ? $dataname : 'Room_list';
	...
	**/
	public function getRenderSystemName()
	{
		...
		if(!defined('ROOMBOOKING_ADMIN_RENDER_REGISTED'))
		{
			define('ROOMBOOKING_ADMIN_RENDER_REGISTED',true);
			$root =& XCube_Root::getSingleton();
			$root->overrideSiteConfig(
				array(
					'RenderSystems' => array(
						'Roombooking_AdminRenderSystem' => 'Roombooking_AdminRenderSystem'
					),
					'Roombooking_AdminRenderSystem' => array(
						'root' => ROOMBOOKING_TRUST_PATH,
						'path' => '/admin/class/RoombookingAdminRenderSystem.class.php',
						'class' => 'Roombooking_AdminRenderSystem'
					)
				)
			);
		}
	
		return 'Roombooking_AdminRenderSystem';
	}
	...
	private function _createAction()
	{
		...
		switch(true)
		{
			case file_exists(
				...
				break;
			case file_exists(
				$path = ROOMBOOKING_TRUST_PATH . '/' . $fileName
			):
				break;
			default:
				return false;
		...
		$className = 'Roombooking_' . ($this->mAdminFlag ? 'Admin_' : '')
			. ucfirst($this->mActionName) . 'Action';
		if(class_exists($className))
		{
			$this->mAction = new $className();
		}
		if(!$this->mAction instanceof Roombooking_AbstractAction)
		{
			return false;
		}
	...
	**/
	...
	{
		/**
		 * Module.roombooking.Global.Event.Exception.ActionNotFound
		 * 
		 * @param	string	$dirname
		 * 
		 * @return	void
		**/
		XCube_DelegateUtils::call('Module.roombooking.Global.Event.Exception.ActionNotFound',$this->mAssetManager->mDirname);
		/**
	...
	**/
	...
	{
		/**
		 * Module.roombooking.Global.Event.Exception.Preparation
		 * 
		 * @param	string	$dirname
		 * 
		 * @return	void
		**/
		XCube_DelegateUtils::call('Module.roombooking.Global.Event.Exception.Preparation',$this->mAssetManager->mDirname);
		/**
	...
	**/
	...
	{
		/**
		 * Module.roombooking.Global.Event.Exception.Permission
		 * 
		 * @param	string	$dirname
		 * 
		 * @return	void
		**/
		XCube_DelegateUtils::call('Module.roombooking.Global.Event.Exception.Permission',$this->mAssetManager->mDirname);
		/**
		...
		**/
		...
		$root =& XCube_Root::getSingleton();
		$root->mController->executeRedirect(XOOPS_URL, 1, _MD_ROOMBOOKING_ERROR_PERMISSION);
	}
}
